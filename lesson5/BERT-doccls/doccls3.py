...
# 'params':net.cls.parameters()：対象のパラメータを指定
...
for ep in range(30):
    ...
    for xs, ys in dataloader:
        ...
        for k in range(len(xs)):
            ...
            # [1] * len(tid)のベクトルをテンソルに
            xmsk.append(torch.LongTensor([1] * len(tid)))
        # batch_first=True：batch_size が先頭に来る
        ...
        optimizer.step()
        i += 1
    outfile = "../outputs/doccls3-" + str(ep) + ".model"
